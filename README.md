...
[ExampleExpectPlatform](common/src/main/java/net/create_more_filters/CreateMoreFiltersExpectPlatform.java) in common 
for an example.
...
of the template. Every `create_more_filters`, every placeholder. 
