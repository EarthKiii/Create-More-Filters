...
public class TagMatchesRegexAttribute implements ItemAttribute {

    public String tag;

    public TagMatchesRegexAttribute(String tag) {
        this.tag = tag;
    }
    ...
    public static class Type implements ItemAttributeType {
        ...
        public @NotNull ItemAttribute createAttribute() {
            return new TagMatchesRegexAttribute(ItemTags.LOGS);
        }

        @Override
        public List<ItemAttribute> getAllAttributes(ItemStack stack, Level level) {
            return stack.getTags()
                    .map(TagMatchesRegexAttribute::new)
