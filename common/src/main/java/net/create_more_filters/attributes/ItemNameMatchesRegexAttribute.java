package net.create_more_filters.attributes;
...
public class ItemNameMatchesRegexAttribute implements ItemAttribute {
    private String itemName;

    public ItemNameMatchesRegexAttribute(String itemName) {
    ...
    public static class Type implements ItemAttributeType {
        ...
        public @NotNull ItemAttribute createAttribute() {
            return new ItemNameMatchesRegexAttribute("dummy");
        }
        ...
        public List<ItemAttribute> getAllAttributes(ItemStack stack, Level level) {
            ...
            if (!name.isEmpty()) {
                list.add(new ItemNameMatchesRegexAttribute(name));
            }
